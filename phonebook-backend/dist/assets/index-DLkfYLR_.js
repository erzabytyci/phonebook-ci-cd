...
function cm() {
  ...
  var K = ($.prototype = new st());
  (K.constructor = $), B(K, C.prototype), (K.isPureReactComponent = !0);
  var it = Array.isArray,
    w = { H: null, A: null, T: null, S: null, V: null },
    ht = Object.prototype.hasOwnProperty;
  function bt(m, H, Y, q, Z, ct) {
    return (
      (Y = ct.ref),
  ...
  function wt(m, H, Y, q, Z) {
    ...
    if (it(m))
      for (var Et = 0; Et < m.length; Et++)
        (q = m[Et]), (ct = ae + Qt(q, Et)), (F += wt(q, H, Y, ct, Z));
    else if (((Et = L(m)), typeof Et == "function"))
      for (m = Et.call(m), Et = 0; !(q = m.next()).done; )
        (q = q.value), (ct = ae + Qt(q, Et++)), (F += wt(q, H, Y, ct, Z));
    else if (ct === "object") {
  ...
  return (
    ...
    (I.cloneElement = function (m, H, Y) {
      ...
      return bt(m.type, Z, void 0, void 0, ct, q);
    }),
    ...
    (I.createElement = function (m, H, Y) {
      ...
      return bt(m, ct, void 0, void 0, null, Z);
    }),
...
function rm() {
  ...
  var Z = H(null),
    ...
    ae = H(null);
  function Et(t, e) {
    switch ((q(F, e), q(ct, t), q(Z, null), e.nodeType)) {
      case 9:
      case 11:
...
` +
  ...
  function tn(t, e, l, a, u, n) {
    ...
    if (((a = t), typeof t == "function")) Vi(t) && (c = 1);
      ...
      t: switch (t) {
        ...
        case w:
          return (t = ce(13, l, e, u)), (t.elementType = w), (t.lanes = n), t;
        case ht:
          return (t = ce(19, l, e, u)), (t.elementType = ht), (t.lanes = n), t;
        default:
          if (typeof t == "object" && t !== null)
            switch (t.$$typeof) {
              case st:
  ...
  function $r(t) {
    ...
    function W(b, v, p, U) {
      for (
        var G = null, et = null, X = v, J = (v = 0), Yt = null;
        X !== null && J < p.length;
        J++
      ) {
        X.index > J ? ((Yt = X), (X = null)) : (Yt = X.sibling);
        var ft = T(b, X, p[J], U);
        if (ft === null) {
          X === null && (X = Yt);
          break;
      ...
      if (J === p.length) return l(b, X), rt && Ul(b, J), G;
      if (X === null) {
        for (; J < p.length; J++)
          (X = N(b, p[J], U)),
            X !== null &&
      ...
      for (X = a(X); J < p.length; J++)
        (Yt = A(X, b, J, p[J], U)),
          Yt !== null &&
            (t &&
              Yt.alternate !== null &&
              X.delete(Yt.key === null ? J : Yt.key),
            (v = n(Yt, v, J)),
    ...
    function V(b, v, p, U) {
      ...
      for (
        var G = null, et = null, X = v, J = (v = 0), Yt = null, ft = p.next();
        X !== null && !ft.done;
        J++, ft = p.next()
      ) {
        X.index > J ? ((Yt = X), (X = null)) : (Yt = X.sibling);
      ...
      if (ft.done) return l(b, X), rt && Ul(b, J), G;
      if (X === null) {
      ...
      for (X = a(X); !ft.done; J++, ft = p.next())
        (ft = A(X, b, J, ft.value, U)),
          ft !== null &&
            (t &&
              ft.alternate !== null &&
              X.delete(ft.key === null ? J : ft.key),
            (v = n(ft, v, J)),
            et === null ? (G = ft) : (et.sibling = ft),
            (et = ft));
      return (
        ...
        if (dt !== 0 && at !== null) {
          ...
          switch (dt) {
            ...
            case 6:
              be.current === null && (e = !0);
              var E = dt;
              if (((dt = 0), (re = null), Oa(t, o, h, E), l && ba)) {
                c = 0;
                break t;
              }
              break;
            default:
              (E = dt), (dt = 0), (re = null), Oa(t, o, h, E);
          }
        }
        ry(), (c = zt);
        break;
  ...
  function $o(t, e, l, a, u, n, c, o, h) {
    ...
    if (e !== null) {
      ...
      if (
        ...
        (a = z.T), (z.T = null), (u = j.p), (j.p = 2), (c = ot), (ot |= 4);
        try {
          ny(t, e, l);
        } finally {
          (ot = c), (j.p = u), (z.T = a);
              ...
              if ((_ === void 0 && (_ = E), "selectionStart" in o))
                ...
                if (T.getSelection) {
                  var A = T.getSelection(),
                    ...
                    V = Math.min(h.start, W),
                    vt = h.end === void 0 ? V : Math.min(h.end, W);
                  !A.extend && V > vt && ((c = vt), (vt = V), (V = c));
                  var b = qs(o, V),
                    v = qs(o, vt);
                  if (
                    b &&
  ...
  function Io() {
    ...
    try {
      ...
      var n = dl,
        c = Ta;
      if (((Xt = 0), (Ea = dl = null), (Ta = 0), (ot & 6) !== 0))
        throw Error(s(331));
      var o = ot;
      if (
        ((ot |= 4),
    ...
    ms(function () {
      ...
      t: {
        ...
        if (T !== void 0) {
          ...
          0 < V.length &&
            ((T = new A(T, W, null, l, _)), N.push({ event: T, listeners: V }));
        }
      }
      if ((e & 7) === 0) {
        t: {
          ...
          if (
            ...
            if (
              ...
              e: {
                for (V = A, b = W, v = 0, p = V; p; p = _a(p)) v++;
        ...
        J &&
          ...
          0 < et.length &&
            ...
            X ? (J.data = X) : ((X = Rs(l)), X !== null && (J.data = X)))),
          (X = z0 ? D0(t, l) : U0(t, l)) &&
...
function ci(i, f, r) {
  ...
  function O(B, Q, C) {
    ...
    if (B && !C && typeof B == "object") {
      if (R.endsWith(Q, "{}"))
        ...
        (R.isArray(B) && av(B)) ||
        ((R.isFileList(B) || R.endsWith(Q, "[]")) && (st = R.toArray(B)))
      )
        return (
          (Q = bh(Q)),
          st.forEach(function (K, it) {
            !(R.isUndefined(K) || K === null) &&
              f.append(
                S === !0 ? Wd([Q], it, y) : S === null ? Q : Q + "[]",
                g(K),
              );
          }),
          !1
    ...
    return jf(B) ? !0 : (f.append(Wd(C, Q, y), g(B)), !1);
  }
  const x = [],
    L = Object.assign(uv, {
      defaultVisitor: O,
  ...
  function lt(B, Q) {
    if (!R.isUndefined(B)) {
      ...
      x.push(B),
        R.forEach(B, function (st, $) {
          (!(R.isUndefined(st) || st === null) &&
            d.call(f, st, R.isString($) ? $.trim() : $, Q, L)) === !0 &&
            lt(st, Q ? Q.concat($) : [$]);
        }),
        x.pop();
    }
      ...
      return new Promise(function (r, s) {
        ...
        "onloadend" in C
          ...
          (C.ontimeout = function () {
            ...
            d.timeoutErrorMessage && (it = d.timeoutErrorMessage),
              s(
                new P(
                  it,
    ...
    (async (i) => {
      ...
      try {
        if (
          ...
          if (
            (R.isFormData(s) &&
              (ht = w.headers.get("content-type")) &&
              O.setContentType(ht),
            w.body)
          ) {
            const [bt, qt] = th(C, ei(eh(M)));
            s = ah(w.body, uh, bt, qt);
          }
        }
        ...
        g = g || "text";
        let it = await li[R.findKey(li, g) || "text"]($, i);
        return (
          !K && Q && Q(),
...
const {
  ...
  Jv = () =>
    At.get(ri).then((i) => i.data.map((f) => ({ ...f, id: Number(f.id) }))),
  ...
  Fv = () => {
    ...
    Xl.useEffect(() => {
      Fn.getAll().then(($) => {
        ...
        const K = $.map((it) => ({ ...it, id: Number(it.id) }));
        f(K);
      });
    }, []);
    const L = ($) => {
        console.log("Typing name.. : ", $.target.value), s($.target.value);
      },
      lt = ($) => {
        console.log("Typing number.. :", $.target.value), y($.target.value);
      },
      B = ($) => {
        console.log("Typing in filter.. :", $.target.value), D($.target.value);
      },
      Q = ($) => {
        $.preventDefault();
        const K = i.find((it) => it.name.toLowerCase() === r.toLowerCase());
        if (K) {
          if (
            ...
            Fn.upgrade(K.id, w)
              ...
              .catch((ht) => {
                ht.response && ht.response.status === 404
                  ...
                  : (x(`Failed to update ${r}. Please try again later.`),
                    setTimeout(() => x(null), 4e3),
                    console.error("Error details:", ht));
              });
          }
        } else {
          const it = { name: r, number: d };
          Fn.create(it).then((w) => {
            f(i.concat(w)), s(""), y("");
          }),
